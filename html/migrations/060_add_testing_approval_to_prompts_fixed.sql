...
-- First, update the status enum to include 'test-ready'
...
-- Add testing and approval columns without foreign keys first
ALTER TABLE project_dev_prompts 
...
ADD CONSTRAINT fk_prompt_response FOREIGN KEY (prompt_id) REFERENCES project_dev_prompts(id) ON DELETE CASCADE;